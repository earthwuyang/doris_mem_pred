...
# Paths to data
train_dataset = 'tpcds'
output_file_csv = f'/home/wuy/DB/doris_mem_pred/{train_dataset}_data/query_mem_data_{train_dataset}_sf100.csv'
output_plan_dir = f"/home/wuy/DB/doris_mem_pred/{train_dataset}_data/plans"
...
# model = XGBRegressor()
# model.load_model(f'{os.getcwd()}/xgboost_model.json')
...
# # save the model as json
# with open('xgboost_model.json', 'w') as f:
#     f.write(model.get_booster().save_model(f'{os.getcwd()}/xgboost_model.json'))
